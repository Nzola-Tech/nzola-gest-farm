...
export async function insertSale(db: Database, total: number, payment: string, createdAt: string) {
    await db.execute(
...
export async function insertSaleItemsAndUpdateStock(db: any, saleId: number, cart: CartItem[], createdAt: string) {
